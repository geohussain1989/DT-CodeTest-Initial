...
class BookingController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->__authenticatedUser->user_type == env('ADMIN_ROLE_ID') || $request->__authenticatedUser->user_type == env('SUPERADMIN_ROLE_ID')) {
            ...
            $response = $this->repository->getUsersJobs($request->__authenticatedUser->user_id);
        }
    ...
    public function distanceFeed(Request $request)
    {
        ...
        if ($data['flagged'] == 'true') {
            if ($data['admincomment'] == '') {
                // return 'Please, add comment'; /// return proper response in
                return response('Please, add commen');
            }
            $flagged = 'yes';
        }
        ...
        /****** Should follow repository patteren approach */
        if ($time || $distance) {
        ...
        return response('Record updated!'); /// like other we pass response object
    }
    ...
    public function resendNotifications(Request $request)
    {
        ...
        return response(['success' => 'Push sent']); // use translation instead of string
    }
